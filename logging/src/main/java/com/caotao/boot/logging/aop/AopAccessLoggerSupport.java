 ...
 */
package com.caotao.boot.logging.aop;
...
import com.caotao.boot.logging.api.AccessLoggerInfo;
import com.caotao.boot.logging.api.AccessLoggerListener;
import com.caotao.boot.logging.api.LoggerDefine;
import com.caotao.boot.logging.api.annotation.AccessLogger;
...
/**
 * 使用AOP记录访问日志,并触发{@link com.caotao.boot.logging.api.AccessLoggerListener#onLogger(AccessLoggerInfo)}
 *
 * @author 曹开魁(Colin)
