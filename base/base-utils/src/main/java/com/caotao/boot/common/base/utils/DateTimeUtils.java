 ...
 *
 * @author 曹开魁(Colin)
 * @version $Id: DateTimeUtils, v0.1 2017年12月25日 17:57 曹开魁(Colin) Exp $
 */
    ...
    public static Date formatUnknownString2Date(String dateString) {
        try {
            ...
            if (StringUtils.contains(dateString, " ")) {
                ...
                // 截取时分秒
                hms = StringUtils.substring(dateString, dateString.indexOf(" ") + 1, dateString.length());

                // 重置日期
                dateString = StringUtils.substring(dateString, 0, dateString.indexOf(" "));
