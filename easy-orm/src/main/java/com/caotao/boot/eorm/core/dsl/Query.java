...
import com.caotao.boot.eorm.core.param.QueryParam;
...
/**
 * @author 曹开魁(Colin)
 * @version $Id: Query, v0.1 2018年01月03日 15:00 曹开魁(Colin) Exp $
 */
public class Query<T, Q extends QueryParam> extends SqlConditionSupport<Query<T, Q>>
        implements Conditional<Query<T, Q>>, TermTypeConditionalFromBeanSupport {
