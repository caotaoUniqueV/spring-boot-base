...
import com.caotao.boot.common.base.utils.file.FileUtils;
import com.caotao.boot.expands.script.engine.ExecuteResult;
import com.caotao.boot.expands.script.engine.ListenerSupportEngine;
import com.caotao.boot.expands.script.engine.ScriptContext;
 ...
 *
 * @author 曹开魁(Colin)
 * @version $Id: JavaEngine, v0.1 2017年12月25日 15:45 曹开魁(Colin) Exp $
 */
public class JavaEngine extends ListenerSupportEngine {
    ...
    public JavaEngine() throws Exception {
        savePath = System.getProperty("java.io.tmpdir").concat("/com/caotao/boot/expands/script/engine/");
