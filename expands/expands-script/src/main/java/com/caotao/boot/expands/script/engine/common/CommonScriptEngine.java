 ...
 */
package com.caotao.boot.expands.script.engine.common;

import com.caotao.boot.expands.script.engine.*;
 ...
 *
 * @author 曹开魁(Colin)
 * @version $Id: CommonScriptEngine, v0.1 2017年12月25日 15:15 曹开魁(Colin) Exp $
 */
public abstract class CommonScriptEngine extends ListenerSupportEngine {
    ...
    @Override
    public com.caotao.boot.expands.script.engine.ScriptContext getContext(String id) {
    ...
    protected class CommonScriptContext extends com.caotao.boot.expands.script.engine.ScriptContext {
